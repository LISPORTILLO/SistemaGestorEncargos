...
public class Profesional extends Usuario { // La clase Profesional hereda de la clase Usuario
    ...
    public Profesional(Integer idUsuario, String nombre, String correo, String contraseña, String rol, String profesion) {
        super(idUsuario, nombre, correo, contraseña, rol); // Llama al constructor de la clase base Usuario
